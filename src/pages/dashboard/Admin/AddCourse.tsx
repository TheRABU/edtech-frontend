...
const AddCourse = () => {
  ...
  const [modules, setModules] = useState<Array<z.infer<typeof moduleSchema>>>([
    { title: "", description: "", duration: 30, order: 1, videoUrl: "" },
  ]);
  const [batches, setBatches] = useState<Array<z.infer<typeof batchSchema>>>([
    { batchId: "", startDate: "", maxStudents: 30 },
  ]);
  ...
  // Helper function to handle date selection for Calendar
  ...
  const onSubmit = async (data: CreateCourseFormData) => {
    try {
      ...
      const result = await createCourse(formattedData).unwrap();
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Fill in the details to create a new course for your LMS.
          </p>
        </div>
